              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Expanded(
                      // This Expanded now works because its parent has a bounded height
                      child: RawScrollbar(
                        ...
                        child: StreamBuilder<List<Map<String, dynamic>>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              physics: const AlwaysScrollableScrollPhysics(), // Ensure scrolling is enabled
          ...
          content: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text("Add Pro", style: TextStyle(color: darkBlue)),
              ),
            ],
          ),
        );
